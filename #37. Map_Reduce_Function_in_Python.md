...
* `filter()`, `map()`, and `reduce()` support **functional programming**
* Enable **lazy evaluation**, improving memory efficiency
* Work seamlessly with **lambda expressions**
* Promote clean, concise, and expressive code

---

## 8. When to Use Map, Filter, and Reduce

**Use them when:**

* Working with data transformations
* Processing large collections
* Writing functional or declarative code
* Avoiding verbose loops

**Avoid them when:**

* Logic becomes too complex
* Readability is better with traditional loops
