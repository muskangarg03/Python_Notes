...
* Enables **direct, clean, and readable value matching**.
* **`case _`** works as the default fallback.
* Provides **less code**, better organization, and improved maintainability.
